...
evm2near: bin/evm2near/Cargo.toml evmlib.wasi
	$(CARGO) build
...
evm2near-macos-arm: bin/evm2near/Cargo.toml evmlib.wasi
...
evm2near-windows-x86.exe: bin/evm2near/Cargo.toml evmlib.wasi
...
evm2near-linux-arm: bin/evm2near/Cargo.toml evmlib.wasi
...
evm2near-linux-x86: bin/evm2near/Cargo.toml evmlib.wasi
...
evmlib.wasm: lib/evmlib/Cargo.toml
...
evmlib.wasi: lib/evmlib/Cargo.toml
