...
evm2near-macos-arm: bin/evm2near/Cargo.toml $(wildcard bin/evm2near/src/*.rs) Makefile evmlib.wasi evmlib.wasm
...
evm2near-macos-x86: bin/evm2near/Cargo.toml $(wildcard bin/evm2near/src/*.rs) Makefile evmlib.wasi evmlib.wasm
	$(CARGO) build --package=evm2near --release --frozen --target=x86_64-apple-darwin
	ln -sf target/x86_64-apple-darwin/release/evm2near $@

evm2near-windows-arm.exe: bin/evm2near/Cargo.toml $(wildcard bin/evm2near/src/*.rs) Makefile evmlib.wasi evmlib.wasm
...
evm2near-windows-x86.exe: bin/evm2near/Cargo.toml $(wildcard bin/evm2near/src/*.rs) Makefile evmlib.wasi evmlib.wasm
	$(CARGO) build --package=evm2near --release --target=x86_64-pc-windows-gnu
	ln -sf target/x86_64-pc-windows-gnu/release/evm2near.exe $@

evm2near-linux-arm: bin/evm2near/Cargo.toml $(wildcard bin/evm2near/src/*.rs) Makefile evmlib.wasi evmlib.wasm
...
evm2near-linux-x86: bin/evm2near/Cargo.toml $(wildcard bin/evm2near/src/*.rs) Makefile evmlib.wasi evmlib.wasm
